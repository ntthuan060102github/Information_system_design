...
{
    public partial class GUI_AddTourModal : Form
    {
        public GUI_AddTourModal()
        {
            InitializeComponent();
        }
        ...
        private void add_tour_modal_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(DanhSachTour.themTour(tenTour, moTa, ngayBatDau, ngayKetThuc, loaiTour, donViLuHanh))
            {
                MessageBox.Show(
                    "Thành công!",
                    "Thông báo!",
